...
public class MockObjectUtil {
    ...
    public static List<Item> generateItemList() {
        ...
        Item item = new Item(9793, "_________________________", "CUPCAKES MINI PARVE", 32, "06B06", 1212);
        item.primaryImageURL = "https://i.pinimg.com/originals/3a/cc/57/3acc578e2f2683eb0da30f5f27163de5.jpg";

        Item item2 = new Item(1234, "AU-9641_M", "MAD MAX CUPCAKES", 12, "B0223f", 3455);
        item2.primaryImageURL = "https://i.ytimg.com/vi/hEJnMQG9ev8/maxresdefault.jpg";

        Item item3 = new Item(5693, "_________________________", "MOUNTAIN DEW CUPCAKES", 500, "B000DR", 9948);
