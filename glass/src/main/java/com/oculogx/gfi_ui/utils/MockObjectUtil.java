...
public class MockObjectUtil {
    ...
    public static List<Item> generateItemList() {
        ...
        item.primaryImageURL = R.drawable.item1side;
        item.secondaryImageURL = R.drawable.item1front;
        ...
        item2.primaryImageURL = R.drawable.item2side;
        item2.secondaryImageURL = R.drawable.item2front;
        ...
        item3.primaryImageURL = R.drawable.item3side;
        item3.secondaryImageURL = R.drawable.item3front;
        ...
        item4.primaryImageURL = R.drawable.item4side;
        item4.secondaryImageURL = R.drawable.item4front;
        ...
        item5.primaryImageURL = R.drawable.item5side;
        item5.secondaryImageURL = R.drawable.item5front;
        ...
        item6.primaryImageURL = R.drawable.item6side;
        item6.secondaryImageURL = R.drawable.item6front;
        ...
        item7.primaryImageURL = R.drawable.item7side;
        item7.secondaryImageURL = R.drawable.item7front;
        ...
        item8.primaryImageURL = R.drawable.item8side;
        item8.secondaryImageURL = R.drawable.item8front;
        //item8.primaryImageURL = "";

        Item item9 = new Item(55050, "________________________", "WILD MUSHROOM MIX IN PAIL", "4/3.3 LB", 45, "26A02", 5900);
        item9.primaryImageURL = R.drawable.item9side;
        item9.secondaryImageURL = R.drawable.item9front;
